...
//     <div className=" m-16 rounded-md shadow-md sm:w-96 dark:bg-gray-900 dark:text-gray-100">
// 	<div className="flex items-center justify-between p-3">
// 		<div className="flex items-center space-x-2">
// 			<img src="https://images.unsplash.com/photo-1665427803235-8e295131ad29?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDQ3fHRvd0paRnNrcEdnfHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=600&q=60" alt="" className="object-cover object-center w-8 h-8 rounded-full shadow-sm dark:bg-gray-500 dark:border-gray-700" />
// 			<div className="-space-y-1">
// 				<h2 className="text-sm font-semibold leading-none">{props.title}</h2>
// 				<span className="inline-block text-xs leading-none dark:text-gray-400">{props.place}</span>
// 			</div>
// 		</div>
...
// 		</button>
// 	</div>
// 	<img src={props.img} alt="" className="object-cover object-center w-full h-72 dark:bg-gray-500" />
// 	<div className="p-3">
...
// 					<span className="font-semibold"> iNeuron</span> and
...
// 			<p className="text-sm">
// 				<span className="text-base font-semibold">{props.title}</span> Hello iNeuron!
// 			</p>
...
function Card({title,place,img}) {  // without using props we can destructuring the object and direct use this.
    return (
      ...
      <div className="p-3">
          ...
          <div className="space-y-3">
              <p className="text-sm">
                  <span className="text-base font-semibold">{title}</span> Hello iNeuron!
              </p>
              <input type="text" placeholder="Add a comment..." className="w-full py-0.5 dark:bg-transparent border-none rounded text-sm pl-0 dark:text-gray-100" />
          </div>
      </div>
